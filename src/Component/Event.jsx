...
function Event() {
    return (
        <>
            <section className=" event-info py-4 overflow-hidden">
                <div className="container overflow-hidden">
                    <div className="organizers d-flex justify-content-space-around flex-wrap text-center">
                        <div className="org-item" data-aos="fade-right" data-aos-duration="1500" data-aos-once="true">
                        ...
                        <div className="org-item" data-aos="fade-left" data-aos-duration="1500" data-aos-once="true">
                            <div className="org-logo shadow">
