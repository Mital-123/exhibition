                ...
                <div className='d-flex justify-content-center align-items-center'>
                  <div className='my-2'>
                    <div className='d-flex align-items-center mb-2'>
                      <IoMdPerson className='text-warning footer_icon' />
                      <span className='ms-2 footer_no'>Kiran Sheth</span>
                    </div>
                    <Link to="tel:9979460009" className='text-light text-decoration-none'>
                      <div className='d-flex align-items-center'>
                        <LuPhoneCall className='text-warning footer_icon' />
                        <span className='ms-2 footer_no'>+91 99794 60009</span>
                      </div>
                    </Link>
                  </div>
                </div>
